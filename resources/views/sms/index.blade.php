    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="../serviceprovider/appointment" class="nav-link">Appointment</a></li>
...
<div class="hero-wrap ftco-degree-bg" style="background-image: {{asset('images/bg_n.jpeg')}}" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
            <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
                <div class="text text-center">
                    <h1 class="mb-4">Treat the customer like  <br> you would want to be treated</h1>

                    <form method="post" class="search-location mt-md-5">
                                ...
                                <div class="form-group">
                                    <div class="form-field">
                                        <table style="width:100%">
                                            <tr>
                                                <td></td>
                                                <h3> SENDER </h3>   <td><input type="text"  value="{{$sms['senderid']}}" name="senderid"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>  <input type="text" class="form-control" placeholder="{{$sms['message']}}"> </td>

                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>  <input type="text" class="form-control" placeholder="" name="msgreply"> </td>
                                            </tr>
                                            <tr>
                                                <td></td>
    ...
    <section class="ftco-section goto-here">
    	<div class="container">
    		<div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
          	<span class="subheading">Offer As your department </span>
            <h2 class="mb-2"> Your Provided Offer </h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-4">
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			...
        			<div class="text">
        				...
        				<h3><a href="#">Daily Basis Car Driver</a></h3>
